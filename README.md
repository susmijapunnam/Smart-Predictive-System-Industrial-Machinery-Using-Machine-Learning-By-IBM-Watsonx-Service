...
├── notebooks/
│   ├── AutoAI_Experiment.ipynb        # AutoAI experiment notebook
│   └── AutoAI_Best_Pipeline_P9.ipynb  # Best pipeline (P9) generated by AutoAI
├── data/
│   └── predictive_maintenance.csv     # Sensor dataset
├── model/
│   ├── model_pipeline_v1.bin          # Trained ML model pipeline v1
│   └── model_pipeline_v2.bin          # Trained ML model pipeline v2
├── presentation/
